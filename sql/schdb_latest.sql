...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2026 at 12:09 PM
...
CREATE TABLE `tb_grades` (
  ...
  `semestral` varchar(10) DEFAULT NULL,
  `status` enum('PASSED','FAILED','INCOMPLETE','DROPPED','PENDING') DEFAULT NULL,
...
(2, 2, 'sir ja', '83.50', '85.75', 'SIR JA', 'PENDING', 1, '2026-02-10 00:19:42'),
(3, 3, '30', '79.50', '91.00', '66.83', 'FAILED', 1, '2026-02-09 23:32:06'),
...
(8, 8, '79.00', '81.50', '84.00', '81.5', 'PASSED', 1, '2026-02-09 23:31:48'),
...
(21, 21, 'INC', 'INC', 'INC', 'INC', 'INCOMPLETE', 1, '2026-02-09 22:45:52'),
...
(77, 77, '90', '76.75', '79.00', '81.92', 'PASSED', 1, '2026-02-09 23:24:29'),
...
(87, 87, '82.75', '85.25', '87.00', '85', 'PASSED', 1, '2026-02-09 23:24:06'),
...
(92, 92, '83.75', '85.50', '87.25', '85.5', 'PASSED', 1, '2026-02-09 23:24:06'),
...
(101, 101, 'INC', '72.50', '70.00', 'INC', 'INCOMPLETE', 1, '2026-02-09 21:31:26'),
...
(111, 111, '85.25', '85.00', '87.25', '85.83', 'PASSED', 1, '2026-02-09 21:31:10'),
...
CREATE TABLE `tb_grade_audit_logs` (
  ...
  `old_prelim` varchar(10) DEFAULT NULL,
  `old_midterm` varchar(10) DEFAULT NULL,
  `old_finals` varchar(10) DEFAULT NULL,
  `old_semestral` varchar(10) DEFAULT NULL,
  `old_status` enum('PASSED','FAILED','INCOMPLETE','DROPPED','PENDING') DEFAULT NULL,
  `new_prelim` varchar(10) DEFAULT NULL,
  `new_midterm` varchar(10) DEFAULT NULL,
  `new_finals` varchar(10) DEFAULT NULL,
  `new_semestral` varchar(10) DEFAULT NULL,
  `new_status` enum('PASSED','FAILED','INCOMPLETE','DROPPED','PENDING') DEFAULT NULL,
...
(3, 2, 1, '78.00', '82.50', '85.75', '82.08', 'PASSED', '78.00', '83.50', '85.75', '82.42', 'PASSED', 'a', '2026-02-09 15:28:44'),
(4, 3, 1, '92.00', '89.50', '91.00', '90.83', 'PASSED', '92.00', '79.50', '91.00', '87.5', 'PASSED', 'test', '2026-02-09 22:49:53'),
(5, 3, 1, '92.00', '79.50', '91.00', '87.5', 'PASSED', 'INC', '79.50', '91.00', 'INC', 'INCOMPLETE', 'cheche', '2026-02-09 23:22:31');
...
(3, 'teacher2', '$2y$10$sKAlkhp5OM7XRd7K4tDiNeVmVbXwW8E4HF20L4zDQo4hw40qVmYNy', 'teacher', 1, '2026-02-02 14:46:48'),
(4, 'teacher3', '$2y$10$sQVBiEwFpdTREcEL2n1xWuyS1FTqqteITCFvpSIPcOt53CdEpvI92', 'teacher', 1, '2026-02-02 14:46:48'),
...
(7, 'student1', '$2y$10$lBja2nZswPs5G0ChIGgXzePo4WrkK.2gV3rLLyaiCUjq3J1DREYAq', 'student', 1, '2026-02-02 14:46:48'),
...
(21, 'student15', '$2y$10$WiG7.esFHVEgyZUb/b6pGOfsbJsb.TcLSrMGlvceFsAfEtDlCkHEC', 'student', 1, '2026-02-02 14:46:48'),
...
--
ALTER TABLE `tb_grades`
  MODIFY `grade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;
